...
This directory contains a JavaScript contract that is used as part of the [Bidding with FTs](https://docs.near.org/tutorials/auction/bidding-with-fts) part of the auction tutorial.
